...
# Exibe o cabeçalho do programa e solicita a quantidade de pizzas.

while True:
    try:
        print("_____________________________________________________________", "\n")
        print("PIZZARIA LMA - SEJA BEM VINDO".center(60), "\n")
        quantidade = int(input("Quantas pizzas você deseja pedir?".center(60)))
        if quantidade < 1:
            print("Você deve pedir pelo menos uma pizza!")
        else:
            break
    except ValueError:
...
# Exibe o resumo do pedido e o preço total a pagar.
    ...
    valor_pedido = preço_pizzasabor + preco_pizzatamanho + preco_refri
    total += valor_pedido
    pedidos.append({ # Responsavel por adicionar as listas de pedidos
    "sabor": sabor_escolhido,
    "tamanho": tamanho_escolhido,
    "refrigerante": refri_escolhido,
    "valor": valor_pedido
    })

    contador += 1

# Exibe o resumo final de todo o pedido de maneira organizada.
